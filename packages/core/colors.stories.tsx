...
storiesOf('Basics/Colors', module)
  .addParameters({
    info: {
      source: false,
      propTablesExclude: [Flex, FlexPismoColor, P, WrapperPismoTheme],
      text: `
    ...
    <WrapperPismoTheme>
      <Flex justifyContent="space-between" flexDirection={['column', 'column', 'row']}>
        <Flex flexDirection="column" width={[1, 1 / 2, 1 / 3]} m="10px">
          <FlexPismoColor backgroundColor={colors.grey} height={100} justifyContent="space-between" alignItems="center">
        ...
        <Flex flexDirection="column" width={[1, 1 / 2, 1 / 3]} m="10px">
          <FlexPismoColor backgroundColor={colors.blue} height={100} justifyContent="space-between" alignItems="center">
        ...
        <Flex flexDirection="column" width={[1, 1 / 2, 1 / 3]} m="10px">
          <FlexPismoColor backgroundColor={colors.red} height={100} justifyContent="space-between" alignItems="center">
