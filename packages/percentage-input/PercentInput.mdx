...
O componente **PercentInput** fornece um componente TextField formatado para valores em porcentagem, pronto para trabalhar com diversas condições de porcentagens em diferentes idiomas.
