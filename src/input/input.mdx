...
> Clicando no ícone, a tooltip pode permanecer visível.
...
O modo readonly remove a interatividade do usuário e adiciona uma formatação específica de acordo com o design system da Pismo.
